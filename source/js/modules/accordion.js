...
const firstOpenQuestionElement = document.querySelector('.faq__question--open + div');
...
const initFaq = () => {
  ...
  buttonsElements.forEach((buttonElement, index) => {
    buttonElement.addEventListener('click', () => {
      ...
      const openQuestionElement = categoriesElements[index].querySelector('.faq__question--open + div');
